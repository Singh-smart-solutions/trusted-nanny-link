...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Simple Nanny Booking in the UAE — Yalla Nanny" },
      { name: "description", content: "Fast, simple nanny booking across Dubai, Abu Dhabi & Sharjah. Book background-checked, insured caregivers by the hour." },
      { property: "og:title", content: "Simple Nanny Booking in the UAE — Yalla Nanny" },
      { property: "og:description", content: "Fast, simple nanny booking across Dubai, Abu Dhabi & Sharjah. Book background-checked, insured caregivers by the hour." },
    ],
  }),
  component: SimpleBookingAppPage,
});
...
const SERVICE_OPTIONS: BookingServiceOption[] = [
  {
    ...
    features: [
      ...
      "DHA First-Aid certified caregiver",
      "Auto-matched top rated nanny",
  ...
  },
  {
    ...
    subtitle: "For infants & newborns under 1 year, tutoring support, or multi-child care.",
    rate: 65,
      ...
      <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-4">
        <div className="flex items-center gap-2">
          ...
          <div className="leading-tight">
            ...
            <div className="text-[10px] uppercase tracking-widest text-muted-foreground">UAE · Simple Nanny Booking</div>
          </div>
        </div>
